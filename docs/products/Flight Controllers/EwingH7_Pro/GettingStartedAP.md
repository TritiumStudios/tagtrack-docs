...
# Getting Started with the Ewing H7 Pro Flight Controller

This guide walks through the initial setup of the **Ewing Aerospace H7 Pro Flight Controller**, from first power-up through basic firmware configuration using **ArduPilot**. It is intended for integrators, manufacturers, and advanced users deploying the H7 Pro in professional or mission-critical unmanned systems.
...
The Ewing H7 Pro supports **ArduPilot** firmware.
...
[Download ardupilot_EAH743Pro (Coming Soon)](./files/betaflight_EAH743Pro.hex)  
