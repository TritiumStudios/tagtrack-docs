...
# Getting Started with the Ewing H7 Pro Flight Controller (Betaflight)

This guide walks through the initial setup of the **Ewing Aerospace H7 Pro Flight Controller** using **Betaflight**, from first power-up through basic firmware configuration. It is intended for integrators, manufacturers, and advanced users deploying the H7 Pro in professional or mission-critical unmanned systems.

---

[[Order Here]](https://www.ewingaerospace.com/products/ewing-aerospace-h7-pro-flight-controller-ndaa-compliant-and-blueuas?variant=43883172462701)
...
- Ewing H7 Pro Flight Controller [[Order Here]](https://www.ewingaerospace.com/products/ewing-aerospace-h7-pro-flight-controller-ndaa-compliant-and-blueuas?variant=43883172462701)
...
> **Note:** The Ewing H7 Pro is not waterproof. If operating in high-humidity or exposed environments, apply conformal coating or use an appropriate enclosure.

---

## Step 2: USB connection and driver verification

1. Connect the Ewing H7 Pro to your computer using a USB-C cable.
...
The Ewing H7 Pro uses the following Betaflight firmware target: $ betaflight_EAH743Pro
...
### Download offical release .hex files: 
**For ICM IMU flight controllers: **
[Download betaflight_EAH743Pro](./files/betaflight_EAH743Pro.hex)
...
For advanced configuration, system integration guidance, and compliance documentation, refer to the additional Ewing H7 Pro documentation pages.

---

## Safety and compliance notice

The Ewing H7 Pro Flight Controller is intended for professional unmanned systems integration. Improper configuration, installation, or operation may result in loss of vehicle control. Always follow applicable regulations, airspace rules, and program-specific safety requirements.
