...
# Getting Started with the Ewing F7 Flight Controller (iNav)

This guide walks through the initial setup of the **Ewing Aerospace Ewing F7 Flight Controller** using **iNav**, from first power-up through basic firmware configuration. It is intended for integrators, manufacturers, and advanced users deploying the Ewing F7 in professional, long-range, or navigation-focused unmanned systems.
...
The Ewing F7 uses the following iNav firmware target: $ RRIOT_F722
