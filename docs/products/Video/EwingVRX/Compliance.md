...
- Designed in the **United States** – system architecture, RF design, and firmware are owned and controlled by Ewing Aerospace.
...
- No restricted-origin RF, communications, or networking silicon is used in the VRX platform.
...
- System operation does not require connectivity to non-compliant infrastructure.
...
The 4-Channel Diversity VRX System is suitable for integration into **NDAA-compliant UAS platforms**, including:
...
- Ground control stations and mobile receive platforms
...
The 4-Channel Diversity VRX System is intended for **professional unmanned systems and ground-station integration**. Improper installation, configuration, or operation may result in degraded performance or regulatory non-compliance. Always follow applicable regulations, RF best practices, and program-specific safety requirements.

---

## FCC Compliance and Regulatory Notice

The **Ewing Aerospace 4-Channel Diversity VRX System** is a **radio frequency receiving device** intended for integration by qualified professionals into unmanned systems, ground stations, and authorized platforms.

### FCC Compliance Status

This device **does not intentionally transmit RF energy** and is intended for **professional, industrial, and government system integration**.

- As a receive-only system, the VRX is generally subject to **FCC Part 15** unintentional radiator requirements, depending on final system configuration.
