...
- Designed in the **United States** – all RF architecture, control logic, and firmware designs are owned and controlled by Ewing Aerospace.
- Final assembly, programming, RF calibration, testing, and quality acceptance performed in our **Ashland, Ohio facilities**.
- Maintains supplier vetting and component traceability controls to ensure ongoing NDAA compliance.
- No restricted-origin RF, communications, networking, or telemetry silicon is used in the BlueLRS platform.

---

## Software and Firmware

- BlueLRS TX firmware does **not incorporate proprietary cloud services, telemetry backhauls, or remote access mechanisms** from prohibited entities.
- Operation and configuration do not require connectivity to non-compliant infrastructure.
- All RF command and telemetry links operate locally between the ground control and air vehicle segments.

---

## Applicability to UAS Programs

The BlueLRS 2.4 GHz TX Module is suitable for integration into **NDAA-compliant UAS platforms**, including:
...
The BlueLRS 2.4 GHz TX Module is intended for professional unmanned systems integration. Improper configuration, installation, or operation may result in loss of vehicle control or communications. Always follow applicable regulations, spectrum use requirements, and program-specific safety guidelines.
