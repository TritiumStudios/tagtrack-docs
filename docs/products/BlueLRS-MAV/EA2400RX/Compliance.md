...
- No restricted-origin RF, communications, or networking silicon is used in the BlueLRS platform.

---

## Software and Firmware

- BlueLRS-MAV RX Firmware does **not incorporate proprietary cloud services, telemetry backhauls, or remote access mechanisms** from prohibited entities.
...
The BlueLRS-MAV 915 MHz RX Module is suitable for integration into **NDAA-compliant UAS platforms**, including:
...
The BlueLRS-MAV 915 MHz RX Module is intended for professional unmanned systems integration. Improper configuration, installation, or operation may result in loss of vehicle control. Always follow applicable regulations, airspace rules, and program-specific safety requirements.
